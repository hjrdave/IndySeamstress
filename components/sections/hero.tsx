...
export function HeroSection() {
  return (
    <section className="relative isolate min-h-[600px] overflow-hidden md:min-h-[750px]">
      ...
      >
        <Image src="/icons/hero/dress-form.png" alt="" fill className="object-contain" />
      </div>
      <div
        aria-hidden="true"
      ...
      >
        <Image src="/icons/hero/needle-thread.png" alt="" fill className="object-contain" />
      </div>
      ...
      <div
        ...
        style={{ left: "8%", top: "78%" }}
      >
        <Image src="/icons/hero/scissors.png" alt="" fill className="object-contain" />
      </div>
      <div
        aria-hidden="true"
      ...
      >
        <Image src="/icons/hero/sewing-machine.png" alt="" fill className="object-contain" />
      </div>
